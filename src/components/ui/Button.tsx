...
const variants: Record<string, string> = {
  primary:
    "bg-gradient-to-r from-electric-500 to-cyan-500 text-white shadow-[0_10px_40px_-10px_rgba(15,139,255,0.7)] hover:shadow-[0_14px_50px_-8px_rgba(15,139,255,0.85)]",
  secondary:
